...
const component_entity_1 = require("./src/components/entities/component.entity");
const AppDataSource = new typeorm_1.DataSource({
    type: 'sqlite',
    database: 'db.sqlite',
    entities: [component_entity_1.Component],
    synchronize: true,
});
const components = [
...
async function seed() {
    ...
    const repo = AppDataSource.getRepository(component_entity_1.Component);
